...
impl Env {
    ...
    pub fn register_contract_wasm<'a>(&self, contract_wasm: &[u8]) -> BytesN<32> {
        self.register_contract_with_source(xdr::CreateContractSource::Installed(
    ...
    pub fn register_contract_token<'a>(&self) -> BytesN<32> {
        self.register_contract_with_source(xdr::CreateContractSource::Ref(
            xdr::ScContractCode::Token,
        ))
    }

    fn register_contract_with_source<'a>(&self, source: xdr::CreateContractSource) -> BytesN<32> {
        ...
        let contract_id: BytesN<32> = self
            ...
            .invoke_function(xdr::HostFunction::CreateContract(xdr::CreateContractArgs {
                contract_id: xdr::ContractId::PublicKey(xdr::ContractIdFromPublicKey {
                    key_source: xdr::ContractIdPublicKey::SourceAccount,
                    salt: xdr::Uint256(random_id()),
                }),
                source,
            }))
            .unwrap()
